...
//
//	//	adminZkClient.createTopic(topicName`1,partitions,replication,
...
//			
//			input = new FileInputStream("/home/ec2-user/MSK_Project/config1.properties");
//			prop.load(input);
...
////		    for(int i = 0; i < 10; i++)
////		    {
////		         producer.send(new ProducerRecord<String, String>(prop.getProperty("TopicName"), 
////		            Integer.toString(i), Integer.toString(i)));
